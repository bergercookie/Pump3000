...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.user_com_btn = QtGui.QCheckBox(Dialog)
        self.user_com_btn.setObjectName("user_com_btn")
        self.horizontalLayout_3.addWidget(self.user_com_btn)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.commands_only.setText(QtGui.QApplication.translate("Dialog", "No Numbering", None, QtGui.QApplication.UnicodeUTF8))
        self.user_com_btn.setText(QtGui.QApplication.translate("Dialog", "User Commands", None, QtGui.QApplication.UnicodeUTF8))
